#!/usr/bin/env python
# Workflow run script auto-generated by command: '/ifs/home/id460/software/manta/manta-1.2.1/bin/configManta.py --exome --referenceFasta /ifs/data/sequence/Illumina/igor/ref/hg19/genome.fa --tumorBam /ifs/data/molecpathlab/NGS580_WES-development/sns-demo/BAM-GATK-RA-RC/SeraCare-1to1-Positive.dd.ra.rc.bam --normalBam /ifs/data/molecpathlab/NGS580_WES-development/sns-demo/BAM-GATK-RA-RC/HapMap-B17-1267.dd.ra.rc.bam --runDir /ifs/data/molecpathlab/NGS580_WES-development/sns-demo/logs-snvs-strelka/SeraCare-1to1-Positive-HapMap-B17-1267-manta'
#

import os, sys

scriptDir=os.path.abspath(os.path.dirname(__file__))
sys.path.append(r'/ifs/home/id460/software/manta/manta-1.2.1/lib/python')
...
main(r"/ifs/data/molecpathlab/NGS580_WES-development/sns-demo/logs-snvs-strelka/SeraCare-1to1-Positive-HapMap-B17-1267-manta/runWorkflow.py.config.pickle","manta",MantaWorkflow)
